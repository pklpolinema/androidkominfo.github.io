            ...
            <div class="page-content page-search">
              ...
              <div class="block searchbar-container">
                <div class="title-container">
                  <h1 style="font-size: 28px;">Event Telah Berlangsung</h1>
                </div>
...
ORDER BY tbl_event.tanggal_awal_event DESC, tbl_event.jam_awal_event DESC';
...
<tbody>';
    ...
    while ($row = mysqli_fetch_array($query))
    {
        ...
        <tr>
            <td>
                <a href='detailEventDaerah2v2.php?id=". $row['idEvent'] ."'>
                  <div class='card card-style-2'>
                    ...
                    <div class='card-infos'>
                      ...
                      <p class='card-description'>Tanggal  : " . tgl_ind($row['tanggal_awal_event']) . " - " . tgl_ind($row['tanggal_akhir_event']) . "</p>
                      <p class='card-description'>Pukul   : "  . $row['jam_awal_event'] . " - " . $row['jam_akhir_event'] . "</p>
                    </div>
                  </div>
                </a>
            </td>
